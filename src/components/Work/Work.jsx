  ...
  return (
   ...
   className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative'>
    ...
    <div className='text-center mb-16'>
      ...
      <div className='w-32 h1 bg-purple-500 mx-auto mt-4'></div>
      <p className="text-gray-400 mt-4 text-lg font-semibold">A showcase of the project I have worked on,highlighting my skills and experience in 
    ...
    <div className='grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
      {projects.map((project)=>(
        ...
        hover:-translate-y-2 transition-transform duration-300'>
          <div className='p-4'>
            <img src={project.image} alt={project.title} className='w-full h-48 object-cover rounded-xl'></img>
          </div>
          <div className='p-6'>
            ...
            <div className='mb-4'>
              {project.tags.map((tag,index)=>(
                <span key={index}
                 className='inline-block bg-[#251f38] text-xs font-semibold text-purple-500 rounded-full px-2 py-1 mb-2'
                 > 
                 {tag}</span>
              ))}
            </div>
            ...
            <h3 className='lg:text-3xl font-bold text-white mb-4 text-md'> 
              ...
              <p className='text-gray-400 mb-6 lg:text-base text-xs'>
                ...
                <div className='flex gap-4'>
                  ...
                  className='w-1/2 bg-gray-600 hover:bg-purple-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center'>
                    view Live
                  </a>
