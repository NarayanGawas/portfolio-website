    ...
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      ...
      <div className="text-white py-5 flex justify-between items-center">
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Gawas</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        {/* Desktop menu */}
...
<button onClick={()=>handleMenuItemClick(item.id)}>
  ...
  <div className="hidden md:flex space-x-4">
    <a href="https://github.com/NarayanGawas" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#8245ec]">
   <FaGithub size={24} /> 
    </a>

    <a href="https://www.linkedin.com/in/narayan-gawas-10207625a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#8245ec]">
   <FaLinkedin size={24} /> 
    </a>
  </div>
   {/* Mobile Menu Icon */}
